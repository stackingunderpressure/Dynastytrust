...
- `HISTORY.md` -- the per-fix record. Every closed bug and audit follow-up,
  with its real root cause, what was deliberately left undone, and the gates
  that were green at the time. Read the entry for the code you are about to
  touch; append one when you close something.
...
6. ~~Legacy Recovery: leaf-list ("generic") vault shape not covered.~~
   ~~On-chain publication of the pad.~~ ~~PDF / audit / tax exports for the
   leaf-list shape.~~ ~~Vault-membership circle invites for the leaf-list
   shape.~~ **All four closed Aug 2026** -- the full accounts, with the root
   cause and the gates green at the time, are in `HISTORY.md`.
...
**Everything that has been closed** -- every fixed bug, audit follow-up and
root cause, with the evidence -- is in `HISTORY.md`. It was 2,100 lines of
this file until 2026-09-16. Read the entry for the code you are about to
touch; append a new one when you close something.
